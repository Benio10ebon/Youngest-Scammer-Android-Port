function onCreatePost()
    ...
    makeLuaText('upText', 'W', 60, getProperty('upButton.x'), getProperty('upButton.y') + 20)
    ...
    makeLuaText('rightText', 'D', 65, getProperty('rightButton.x') - 2, getProperty('rightButton.y') + 20)
...
function onUpdate(elapsed)
    ...
    if keyPressed('up') then
        ...
        doTweenAlpha('upFade', 'upButton', 0.3, 0.30, 'linear')
    ...
    if keyPressed('down') then
        ...
        doTweenAlpha('downFade', 'downButton', 0.3, 0.30, 'linear')
    ...
    if keyPressed('left') then
        ...
        doTweenAlpha('leftFade', 'leftButton', 0.3, 0.30, 'linear')
    ...
    if keyPressed('right') then
        ...
        doTweenAlpha('rightFade', 'rightButton', 0.3, 0.30, 'linear')
